...
export function RevisionSkillsPanel({
    ...
    return (
        <Surface
            className="admin-content-revision-skills"
            elevated
        >
                ...
                {!editable ? (
                    ...
                    >
                        <label>
                            ...
                            <select
                                aria-label="Skill Placement للمراجعة"
                                required
                                value={
                                    selectedPlacementId
                                }
