...
## Authority
Architecture → Domain Model → Measurement Semantics → Schema Design → DDL Plan → Integrity Rules → Deferred Decisions → Engineering Review Guide.
